...
private:
	...
	vkSwapChainSupportDetails querySwapChainSupport(VkPhysicalDevice vkPhysicalDevice) {
		vkSwapChainSupportDetails vkDetails;
	...
	vkQueueFamilyIndices queryQueueFamilies(VkPhysicalDevice vkPhysicalDevice) {
		vkQueueFamilyIndices vkIndices;
	...
	void initVkLogicalDevice() {
		vkQueueFamilyIndices indices = queryQueueFamilies(vkMainPhysicalDevice);
	...
	void initVkSwapChain() {
		vkSwapChainSupportDetails vkDetails = querySwapChainSupport(vkMainPhysicalDevice);
		...
		vkQueueFamilyIndices vkIndices = queryQueueFamilies(vkMainPhysicalDevice);
	...
	void initVkCommandPool() {
		vkQueueFamilyIndices queueFamilyIndices = queryQueueFamilies(vkMainPhysicalDevice);
	...
	void clear() {
		...
		std::for_each(vkSwapchainFramebuffers.begin(), vkSwapchainFramebuffers.end(), [&](VkFramebuffer vkFramebuffer) {
